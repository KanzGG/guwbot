...
const BotName = 'KanzBOT'; // GANTI PAKE NAMA BOT LU
...
const ow = 'Kanz'; // GANTI PAKE NAMA MU
const nomorowner = '0822-5245-2100'; // GANTI PAKE NOMOR MU ( JANGAN NOMOR BOT )
const ovo = 'Nothing'; // GANTI PAKE NOMOR OVO LU
const pulsa = '0821-4850-5737'; // GANTI PAKE NOMOR PULSA LU
const dana = 'nothing'; // GANTI PAKE NOMOR DANA LU
const gopay = 'nothing'; // GANTI PAKE NOMOR GOPAY LU
const instagram = 'Gada'; // GANTI IG LU
const aktif = '08:00 - 22:00'; // TERSERAH LU DAH INI
const vcard = 'BEGIN:VCARD\n'
  + 'VERSION:3.0\n' // MAU NGAPAIN TOD
  + 'FN:Kanz GANS\n' // GANTI PAKE NAMA MU
  + 'ORG:Kanz BOT;\n' // INI BIARIN GPP, GANTI PAKE NAMA BOT BOLEH
  + 'TEL;type=CELL;type=VOICE;waid=6282252452100:+62 8225-2452-100\n' // GANTI PAKE NOMOR LU ( SAMAIN KEK GITU YA )
